...
class scintilla {
    ...
    __call(msg, ByRef wParam=0, ByRef lParam=0, params*){
        ...
        {
            static _MsgWithInputStringParam:={addtext:2,appendtext:2,changeinsertion:2,clearrepresentation:1,describeproperty:1,encodedfromutf8:1,getproperty:1,getpropertyexpanded:1,getpropertyint:1,getrepresentation:1,inserttext:2,propertytype:1,registerimage:2,registerrgbaimage:2,setidentifiers:2,setproperty:3,setpunctuationchars:2,setrepresentation:3,settext:2,setwhitespacechars:2,setwordchars:2,textwidth:2,STYLESETFONT:2,AutocShow:2}
